...
//            return null;
//        } finally {
//            DataSourceUtils.close(conn, pstm, null);
//        }
//    }
//
//    /**
...
//        try {
//            //建立到指定数据库 URL 的连接
//            conn1 = DataSourceUtils.getConnection();
//
//            //第一次查询数据库 查询该用户是否注册过
...
//
//            conn2 = DataSourceUtils.getConnection();
...
//        } finally {
//            if (conn2 != null) {
//                DataSourceUtils.close(conn2, pstm2, rs2); //先关闭连接2
//            }
//            DataSourceUtils.close(conn1, pstm1, rs1); //最后关闭连接1
//        }
//        return returnnum;
//    }
//}
