package com.mall.login.servlet;
...
public class UserServlet extends HttpServlet {
    ...
    public void login(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null) {
                ...
                request.getRequestDispatcher("/com/mall/page.jsp").forward(request,
                        response);
                return;
            }
            ...
            request.getRequestDispatcher("/com/mall/page.jsp")
    ...
    public void regist(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("_checkcode" + _checkcode);
        if (_checkcode == null || (!_checkcode.equals(checkcode))) {
            request.setAttribute("regist.message", "验证码不正确");
            request.getRequestDispatcher("/com/mall/register.jsp").forward(request,
                    response);
            return;
        }
